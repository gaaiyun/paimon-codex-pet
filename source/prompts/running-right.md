...
Final export repair: exactly eight evenly spaced poses, one centered in each equal-width slot with generous cyan gaps. No pose crosses a slot boundary. Keep scale and baseline stable.
